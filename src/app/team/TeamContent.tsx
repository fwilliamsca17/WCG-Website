    ...
    <>
      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-b from-slate-950 to-navy-950">
        ...
        <div className="relative max-w-7xl mx-auto section-padding">
          <FadeIn>
            <p className="label-text text-silver-400 mb-4">Leadership</p>
                ...
                <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden mb-8">
                  <div className="grid md:grid-cols-[300px_1fr] gap-0">
                    ...
                    <div className="p-8 md:p-10">
                      <h3 className="font-serif text-heading-lg font-bold text-slate-950 mb-1">
                        {member.name}
                      </h3>
                      <p className="text-navy-700 font-medium text-body mb-6">
                        {member.title}
                      </p>
                      ...
                      <div className="flex items-center gap-4">
                        {member.linkedin && (
                          <a
                            ...
                            className="inline-flex items-center gap-2 text-slate-500 hover:text-navy-700 transition-colors text-body-sm"
                          >
