...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Accent lines */}
      <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-navy-600/30 to-transparent" />
      <div className="absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-silver-500/20 to-transparent" />
      ...
      <div className="relative max-w-7xl mx-auto section-padding w-full pt-32 pb-20">
        <div className="max-w-3xl">
          <motion.p
            ...
            className="label-text text-silver-400 mb-6"
          >
          ...
          >
            ...
            <Button href="/strategy" variant="outline" size="lg" className="border-white/30 text-white hover:bg-white hover:text-slate-950 hover:border-white">
              Investment Strategy
            </Button>
          </motion.div>
        </div>
